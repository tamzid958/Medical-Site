<section>
  <div class="parallax">
    <h5 class="text-center testi-head">Testimonials</h5>
    <h3 class="text-center testi-head testi-head-sec">What Our Clients Say</h3>
    <div class="testimonials">
      <div class="snip1192">
        ...
        <div class="author">
          <img src="/assets/images/adult-beard-boy-casual-220453.jpg" alt="sq-sample1" />
          <h5>Pelican Steve <span> LittleSnippets</span></h5>
        </div>
      </div>
      <div class="snip1192 testimonials-two hover">
        ...
        <div class="author">
          <img src="/assets/images/women-s-white-and-black-button-up-collared-shirt-774909.jpg" alt="sq-sample24" />
          <h5>Max Conversion<span> LittleSnippets</span></h5>
        </div>
      </div>
      <div class="snip1192 testimonials-three">
        ...
        <div class="author">
          <img src="/assets/images/man-crossed-arms-1516680.jpg" alt="sq-sample29" />
